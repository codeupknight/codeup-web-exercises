...
<body>
  ...
  <div class="col-sm-12 partners-bg" id="partners">
    ...
    <div class="col-sm-4">
      ...
      <div class="col-sm-4">
      <img src="photos/rivard.jpg" class="partners-img">
    </div>
    <div class="col-sm-4">
    ...
    <div class="col-sm-4">
      <img src="photos/ksym.jpg" class="partners-img">
    </div>
</div>
    <div class="col-sm-12">
      <h5 class="white-text no-shadow">Copyright San Antonio Local Music 2016, All Rights Reserved.</h5>
    </div>
</body>
</html>